...
<head>
	<title>Aao Travels </title>
	  ...
	  <link href="/aao_travels/css/fontawesome/css/all.css" type="text/css" rel="stylesheet" />
  	  <!-------- Manual css ----->
...
<body>
	<div class="row color-row gap-prty" >
		 ...
		 <?php 
		 	...
		 	{
		?>
		 	<a href="Admin/logout.php" class="text-color">
		...
		<?php  	}
		 	...
		 	{
		 ?>
		 	<a href="Admin/login.php" class="text-color">
		 ...
		 <?php 
		 	...
		 	{
		 ?>
		 <a href="Admin/signin.php" class="text-color">

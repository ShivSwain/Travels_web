	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<center> <label class="add-pkg-form">UPDATE PACKAGE FORM </label> </center>
			</div>
		</div>
		<form class="package-form" id="formsubmit" action="pkgupdate.php" method="POST">
			<div class="row">
				<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<input type="submit" name="submit" value="UPDATE" class="add">
				</div>
			</div>
		</form>
	</div>
